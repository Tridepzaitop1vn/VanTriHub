...
local Window = OrionLib:MakeWindow({Name = "VĂN TRI HUB", HidePremium = false, IntroText = "Trí gaming Library", SaveConfig = true, ConfigFolder = "VAN TRI HUB"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Hồ sơ thông tin của bạn",
    Icon = "rbxassetid://16249709414",
    PremiumOnly = false
})
...
local Wld = Window:MakeTab({
    Name = "Teleport by trí",
    Icon = "rbxassetid://16249709414",
    PremiumOnly = false
})

local SV = Window:MakeTab({
    Name = "Server information by trí",
    Icon = "rbxassetid://16249709414",
    PremiumOnly = false
})

local D = Window:MakeTab({
    Name = "Fruits cực múp by trí",
    Icon = "rbxassetid://16249709414",
    PremiumOnly = false
})
...
M:AddToggle({
    Name = "Stop when there is cup and key",
    Default = false,
...
spawn(function()
    ...
    M:AddToggle({
        Name = "Hop sv Farm observation haki",
        Default = false,
